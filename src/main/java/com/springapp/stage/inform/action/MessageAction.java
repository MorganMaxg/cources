...
public class MessageAction {
    ...
    public String query(ModelMap model, HttpServletRequest request) {
        ...
        try {
            page.setTotalCount(ServletRequestUtils.getIntParameter(request, "totalCount", messageManager.countMessages()));
            List<Message> messages = messageManager.findMessages(page);
